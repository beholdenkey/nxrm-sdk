...
class ReadLdapServerXo:
    ...
    def __init__(
        ...
        """ReadLdapServerXo - a model defined in Swagger"""  # noqa: E501
        self._name = None
        self._protocol = None
    ...
    def protocol(self, protocol):
        ...
        if protocol not in allowed_values:
            raise ValueError(
                'Invalid value for `protocol` ({}), must be one of {}'.format(  # noqa: E501
    ...
    def auth_scheme(self, auth_scheme):
        ...
        if auth_scheme not in allowed_values:
            raise ValueError(
                'Invalid value for `auth_scheme` ({}), must be one of {}'.format(  # noqa: E501
    ...
    def group_type(self, group_type):
        ...
        if group_type not in allowed_values:
            raise ValueError(
                'Invalid value for `group_type` ({}), must be one of {}'.format(  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in self.swagger_types.items():
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ReadLdapServerXo, dict):
