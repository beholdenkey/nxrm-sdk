...
class ApiPrivilegeRepositoryAdminRequest:
    ...
    def __init__(
        self, name=None, description=None, actions=None, format=None, repository=None
    ):  # noqa: E501
        """ApiPrivilegeRepositoryAdminRequest - a model defined in Swagger"""  # noqa: E501
        self._name = None
    ...
    def actions(self, actions):
        ...
        if not set(actions).issubset(set(allowed_values)):
            raise ValueError(
                'Invalid values for `actions` [{}], must be a subset of [{}]'.format(  # noqa: E501
                    ', '.join(
    ...
    def to_dict(self):
        ...
        for attr, _ in self.swagger_types.items():
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ApiPrivilegeRepositoryAdminRequest, dict):
