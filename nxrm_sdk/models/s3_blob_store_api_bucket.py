...
class S3BlobStoreApiBucket:
    ...
    def __init__(
        self, region=None, name=None, prefix=None, expiration=None
    ):  # noqa: E501
        """S3BlobStoreApiBucket - a model defined in Swagger"""  # noqa: E501
        self._region = None
        self._name = None
        self._prefix = None
    ...
    def to_dict(self):
        ...
        for attr, _ in self.swagger_types.items():
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(S3BlobStoreApiBucket, dict):
