...
class TasksApi(object):
    ...
    def get_task_by_id_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        if "id" not in params or params["id"] is None:
            raise ValueError(
                "Missing the required parameter `id` when calling `get_task_by_id`"
            )  # noqa: E501
    ...
    def run(self, id, **kwargs):  # noqa: E501
        ...
        if kwargs.get("async_req"):
            ...
            (data) = self.run_with_http_info(id, **kwargs)  # noqa: E501
            return data
    ...
    def run_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        for key, val in six.iteritems(params["kwargs"]):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'" " to method run" % key
                )
            params[key] = val
        del params["kwargs"]
        # verify the required parameter 'id' is set
    ...
    def stop_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        for key, val in six.iteritems(params["kwargs"]):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'" " to method stop" % key
                )
            params[key] = val
        del params["kwargs"]
        # verify the required parameter 'id' is set
