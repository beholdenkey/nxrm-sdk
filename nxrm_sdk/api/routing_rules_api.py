...
class RoutingRulesApi(object):
    ...
    def create_routing_rule(self, body, **kwargs):  # noqa: E501
        ...
        if kwargs.get("async_req"):
            ...
            (data) = self.create_routing_rule_with_http_info(
                body, **kwargs
            )  # noqa: E501
            return data
    ...
    def delete_routing_rule(self, name, **kwargs):  # noqa: E501
        ...
        if kwargs.get("async_req"):
            ...
            (data) = self.delete_routing_rule_with_http_info(
                name, **kwargs
            )  # noqa: E501
            return data
    ...
    def delete_routing_rule_with_http_info(self, name, **kwargs):  # noqa: E501
        ...
        if "name" not in params or params["name"] is None:
            raise ValueError(
                "Missing the required parameter `name` when calling `delete_routing_rule`"
            )  # noqa: E501
    ...
    def get_routing_rule_with_http_info(self, name, **kwargs):  # noqa: E501
        ...
        if "name" not in params or params["name"] is None:
            raise ValueError(
                "Missing the required parameter `name` when calling `get_routing_rule`"
            )  # noqa: E501
    ...
    def update_routing_rule(self, body, name, **kwargs):  # noqa: E501
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.update_routing_rule_with_http_info(
                body, name, **kwargs
            )  # noqa: E501
        else:
            (data) = self.update_routing_rule_with_http_info(
                body, name, **kwargs
            )  # noqa: E501
            return data
