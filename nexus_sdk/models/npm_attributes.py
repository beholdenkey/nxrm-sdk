...
class NpmAttributes(object):
    ...
    def __init__(self, remove_non_cataloged=None, remove_quarantined=None):  # noqa: E501
    ...
    def remove_quarantined(self, remove_quarantined):
        ...
        if remove_quarantined is None:
            raise ValueError("Invalid value for `remove_quarantined`, must not be `None`")  # noqa: E501
