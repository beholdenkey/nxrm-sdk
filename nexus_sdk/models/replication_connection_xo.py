...
class ReplicationConnectionXO(object):
    ...
    def __init__(self, id=None, name=None, source_repository_name=None, destination_instance_url=None, destination_instance_username=None, destination_instance_password=None, destination_repository_name=None, content_regexes=None, include_existing_content=None, use_trust_store=None):  # noqa: E501
    ...
    def source_repository_name(self, source_repository_name):
        ...
        if source_repository_name is None:
            raise ValueError("Invalid value for `source_repository_name`, must not be `None`")  # noqa: E501
    ...
    def destination_instance_url(self, destination_instance_url):
        ...
        if destination_instance_url is None:
            raise ValueError("Invalid value for `destination_instance_url`, must not be `None`")  # noqa: E501
    ...
    def destination_repository_name(self, destination_repository_name):
        ...
        if destination_repository_name is None:
            raise ValueError("Invalid value for `destination_repository_name`, must not be `None`")  # noqa: E501
