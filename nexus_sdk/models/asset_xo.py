...
class AssetXO(object):
    ...
    def __init__(self, download_url=None, path=None, id=None, repository=None, format=None, checksum=None, content_type=None, last_modified=None, last_downloaded=None, uploader=None, uploader_ip=None, file_size=None):  # noqa: E501
