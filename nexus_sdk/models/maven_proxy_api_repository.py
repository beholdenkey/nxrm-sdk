...
class MavenProxyApiRepository(object):
    ...
    def __init__(self, name=None, online=None, storage=None, cleanup=None, proxy=None, negative_cache=None, http_client=None, routing_rule_name=None, replication=None, maven=None):  # noqa: E501
