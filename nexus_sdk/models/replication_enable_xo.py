...
class ReplicationEnableXO(object):
    ...
    def __init__(self, target_repository_name=None, replication_connection_name=None, source_repository_name=None):  # noqa: E501
    ...
    def target_repository_name(self, target_repository_name):
        ...
        if target_repository_name is None:
            raise ValueError("Invalid value for `target_repository_name`, must not be `None`")  # noqa: E501
    ...
    def replication_connection_name(self, replication_connection_name):
        ...
        if replication_connection_name is None:
            raise ValueError("Invalid value for `replication_connection_name`, must not be `None`")  # noqa: E501
