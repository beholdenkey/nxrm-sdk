...
class IqConnectionXo(object):
    ...
    def authentication_type(self, authentication_type):
        ...
        if authentication_type is None:
            raise ValueError(
                "Invalid value for `authentication_type`, must not be `None`"
            )  # noqa: E501
        allowed_values = ["USER", "PKI"]  # noqa: E501
        if authentication_type not in allowed_values:
            raise ValueError(
                "Invalid value for `authentication_type` ({0}), must be one of {1}".format(  # noqa: E501
                    authentication_type, allowed_values
                )
            )
