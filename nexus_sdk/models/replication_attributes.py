...
class ReplicationAttributes(object):
    ...
    def __init__(self, preemptive_pull_enabled=None, asset_path_regex=None):  # noqa: E501
    ...
    def preemptive_pull_enabled(self, preemptive_pull_enabled):
        ...
        if preemptive_pull_enabled is None:
            raise ValueError("Invalid value for `preemptive_pull_enabled`, must not be `None`")  # noqa: E501
