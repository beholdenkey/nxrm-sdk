...
class CrowdApiXO(object):
    ...
    def __init__(self, enabled=None, realm_active=None, application_name=None, application_password=None, url=None, use_trust_store_for_url=None, timeout=None):  # noqa: E501
    ...
    def realm_active(self, realm_active):
        ...
        if realm_active is None:
            raise ValueError("Invalid value for `realm_active`, must not be `None`")  # noqa: E501
