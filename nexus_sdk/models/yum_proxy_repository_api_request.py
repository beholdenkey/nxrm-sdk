...
class YumProxyRepositoryApiRequest(object):
    ...
    def __init__(self, name=None, online=None, storage=None, cleanup=None, proxy=None, negative_cache=None, http_client=None, routing_rule=None, replication=None, yum_signing=None):  # noqa: E501
