...
# body param
SchemaForRequestBodyApplicationJson = FileBlobStoreApiCreateRequest
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_file_blob_store_oapg(
        self,
...
class CreateFileBlobStore(BaseApi):
    ...
    def create_file_blob_store(
        ...
        return self._create_file_blob_store_oapg(
            body=body,
