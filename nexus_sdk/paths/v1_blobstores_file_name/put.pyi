...
# body param
SchemaForRequestBodyApplicationJson = FileBlobStoreApiUpdateRequest
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_file_blob_store_oapg(
        self,
...
class UpdateFileBlobStore(BaseApi):
    ...
    def update_file_blob_store(
        ...
        return self._update_file_blob_store_oapg(
            body=body,
