...
# body param
SchemaForRequestBodyApplicationJson = UserTokensApiModel
...
SchemaFor200ResponseBodyApplicationJson = UserTokensApiModel
...
class SetServiceStatus(BaseApi):
    ...
    def set_service_status(
        ...
        return self._set_service_status_oapg(
            body=body,
