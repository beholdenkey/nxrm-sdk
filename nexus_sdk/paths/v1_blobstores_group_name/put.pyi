...
# body param
SchemaForRequestBodyApplicationJson = GroupBlobStoreApiUpdateRequest
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_group_blob_store_oapg(
        self,
...
class UpdateGroupBlobStore(BaseApi):
    ...
    def update_group_blob_store(
        ...
        return self._update_group_blob_store_oapg(
            body=body,
