...
# body param
SchemaForRequestBodyApplicationJson = SupportZipGeneratorRequest
...
SchemaFor200ResponseBodyApplicationJson = SupportZipXO
...
class Supportzippath(BaseApi):
    ...
    def supportzippath(
        ...
        return self._supportzippath_oapg(
            body=body,
