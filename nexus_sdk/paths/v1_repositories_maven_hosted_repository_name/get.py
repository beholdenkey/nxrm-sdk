...
SchemaFor200ResponseBodyApplicationJson = MavenHostedApiRepository
...
class GetRepository2(BaseApi):
    ...
    def get_repository2(
        ...
        return self._get_repository2_oapg(
