...
# body param
SchemaForRequestBodyApplicationJson = ContentSelectorApiCreateRequest
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_content_selector_oapg(
        self,
...
class CreateContentSelector(BaseApi):
    ...
    def create_content_selector(
        ...
        return self._create_content_selector_oapg(
            body=body,
