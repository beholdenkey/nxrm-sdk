...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['UploadDefinitionXO']:
            return UploadDefinitionXO

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['UploadDefinitionXO'], typing.List['UploadDefinitionXO']],
    ...
    def __getitem__(self, i: int) -> 'UploadDefinitionXO':
