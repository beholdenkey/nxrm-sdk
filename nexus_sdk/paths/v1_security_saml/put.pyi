...
# body param
SchemaForRequestBodyApplicationJson = SamlConfigurationXO
...
class BaseApi(api_client.Api):
    @typing.overload
    def _put_saml_configuration_oapg(
        self,
...
class PutSamlConfiguration(BaseApi):
    ...
    def put_saml_configuration(
        ...
        return self._put_saml_configuration_oapg(
            body=body,
