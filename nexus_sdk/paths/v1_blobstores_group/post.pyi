...
# body param
SchemaForRequestBodyApplicationJson = GroupBlobStoreApiCreateRequest
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_group_blob_store_oapg(
        self,
...
class CreateGroupBlobStore(BaseApi):
    ...
    def create_group_blob_store(
        ...
        return self._create_group_blob_store_oapg(
            body=body,
