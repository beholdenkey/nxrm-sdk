...
# body param
SchemaForRequestBodyApplicationJson = ContentSelectorApiUpdateRequest
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_content_selector_oapg(
        self,
...
class UpdateContentSelector(BaseApi):
    ...
    def update_content_selector(
        ...
        return self._update_content_selector_oapg(
            body=body,
