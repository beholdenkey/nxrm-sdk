...
SchemaFor200ResponseBodyApplicationJson = ContentSelectorApiResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_content_selector_oapg(
        self,
...
class GetContentSelector(BaseApi):
    ...
    def get_content_selector(
        ...
        return self._get_content_selector_oapg(
