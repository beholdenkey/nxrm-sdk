...
SchemaFor200ResponseBodyApplicationJson = ScriptResultXO
...
class BaseApi(api_client.Api):
    ...
    def _run1_oapg(
        self,
        content_type: str = ...,
        body: typing.Union[SchemaForRequestBodyTextPlain, str, SchemaForRequestBodyApplicationJson, str, schemas.Unset] = schemas.unset,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
        timeout: typing.Optional[typing.Union[int, typing.Tuple]] = None,
