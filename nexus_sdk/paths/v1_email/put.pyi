...
# body param
SchemaForRequestBody = ApiEmailConfiguration
...
class BaseApi(api_client.Api):
    @typing.overload
    def _set_email_configuration_oapg(
        self,
...
class SetEmailConfiguration(BaseApi):
    ...
    def set_email_configuration(
        ...
        return self._set_email_configuration_oapg(
            body=body,
