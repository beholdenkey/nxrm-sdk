...
# body param
SchemaForRequestBodyApplicationJson = AzureBlobStoreApiModel
...
class CreateBlobStore1(BaseApi):
    ...
    def create_blob_store1(
        ...
        return self._create_blob_store1_oapg(
            body=body,
