...
class SecurityCertificatesApi(object):
    ...
    def add_certificate_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v1/security/ssl/truststore', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_trust_store_certificates(self, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.get_trust_store_certificates_with_http_info(**kwargs)  # noqa: E501
            return data
    ...
    def get_trust_store_certificates_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v1/security/ssl/truststore', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def remove_certificate_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `remove_certificate`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v1/security/ssl/truststore/{id}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def retrieve_certificate(self, host, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.retrieve_certificate_with_http_info(host, **kwargs)  # noqa: E501
            return data
    ...
    def retrieve_certificate_with_http_info(self, host, **kwargs):  # noqa: E501
        ...
        if ('host' not in params or
                params['host'] is None):
            raise ValueError("Missing the required parameter `host` when calling `retrieve_certificate`")  # noqa: E501
