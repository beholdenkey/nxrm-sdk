...
class DockerHostedStorageAttributes(schemas.DictSchema):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class writePolicy(schemas.EnumBase, schemas.StrSchema):
                class MetaOapg:
                    enum_value_to_name = {
                        "allow": "ALLOW",
    ...
    @typing.overload
    def __getitem__(
        self, name: typing_extensions.Literal["writePolicy"]
    ) -> MetaOapg.properties.writePolicy:
        ...
    ...
    @typing.overload
    def __getitem__(
        self, name: typing_extensions.Literal["latestPolicy"]
    ) -> MetaOapg.properties.latestPolicy:
        ...
    ...
    def get_item_oapg(
        self, name: typing_extensions.Literal["latestPolicy"]
    ) -> typing.Union[MetaOapg.properties.latestPolicy, schemas.Unset]:
        ...
    ...
    def __new__(
        ...
        *_args: typing.Union[
        ...
        latestPolicy: typing.Union[
            MetaOapg.properties.latestPolicy, bool, schemas.Unset
        ] = schemas.unset,
