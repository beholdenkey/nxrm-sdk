...
class DockerProxyApiRepository(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def dockerProxy() -> typing.Type['DockerProxyAttributes']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["dockerProxy"]) -> 'DockerProxyAttributes': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["online", "storage", "proxy", "negativeCache", "httpClient", "docker", "dockerProxy", "name", "cleanup", "routingRuleName", "replication", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["dockerProxy"]) -> 'DockerProxyAttributes': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["online", "storage", "proxy", "negativeCache", "httpClient", "docker", "dockerProxy", "name", "cleanup", "routingRuleName", "replication", ], str]):
