...
class NugetProxyApiRepository(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def nugetProxy() -> typing.Type['NugetAttributes']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["nugetProxy"]) -> 'NugetAttributes': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["online", "storage", "proxy", "negativeCache", "httpClient", "nugetProxy", "name", "cleanup", "routingRuleName", "replication", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["nugetProxy"]) -> 'NugetAttributes': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["online", "storage", "proxy", "negativeCache", "httpClient", "nugetProxy", "name", "cleanup", "routingRuleName", "replication", ], str]):
