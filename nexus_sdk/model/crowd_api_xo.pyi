...
class CrowdApiXO(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["realmActive"]) -> MetaOapg.properties.realmActive: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["applicationName"]) -> MetaOapg.properties.applicationName: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["applicationPassword"]) -> MetaOapg.properties.applicationPassword: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["enabled", "realmActive", "applicationName", "applicationPassword", "url", "useTrustStoreForUrl", "timeout", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["realmActive"]) -> MetaOapg.properties.realmActive: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["applicationPassword"]) -> typing.Union[MetaOapg.properties.applicationPassword, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["enabled", "realmActive", "applicationName", "applicationPassword", "url", "useTrustStoreForUrl", "timeout", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        realmActive: typing.Union[MetaOapg.properties.realmActive, bool, ],
        ...
        applicationPassword: typing.Union[MetaOapg.properties.applicationPassword, str, schemas.Unset] = schemas.unset,
