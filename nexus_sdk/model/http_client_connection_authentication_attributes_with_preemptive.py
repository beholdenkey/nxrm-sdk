...
class HttpClientConnectionAuthenticationAttributesWithPreemptive(schemas.DictSchema):
    ...
    @typing.overload
    def __getitem__(
        self, name: typing_extensions.Literal["preemptive"]
    ) -> MetaOapg.properties.preemptive:
        ...
    ...
    def get_item_oapg(
        self, name: typing_extensions.Literal["preemptive"]
    ) -> typing.Union[MetaOapg.properties.preemptive, schemas.Unset]:
        ...
    ...
    def __new__(
        ...
        *_args: typing.Union[
        ...
        preemptive: typing.Union[
            MetaOapg.properties.preemptive, bool, schemas.Unset
        ] = schemas.unset,
