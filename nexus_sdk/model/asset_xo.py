...
class AssetXO(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["lastDownloaded"]) -> MetaOapg.properties.lastDownloaded: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["uploader"]) -> MetaOapg.properties.uploader: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["uploaderIp"]) -> MetaOapg.properties.uploaderIp: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["downloadUrl", "path", "id", "repository", "format", "checksum", "contentType", "lastModified", "lastDownloaded", "uploader", "uploaderIp", "fileSize", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["lastDownloaded"]) -> typing.Union[MetaOapg.properties.lastDownloaded, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["uploader"]) -> typing.Union[MetaOapg.properties.uploader, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["uploaderIp"]) -> typing.Union[MetaOapg.properties.uploaderIp, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["downloadUrl", "path", "id", "repository", "format", "checksum", "contentType", "lastModified", "lastDownloaded", "uploader", "uploaderIp", "fileSize", ], str]):
        return super().get_item_oapg(name)
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        checksum: typing.Union[MetaOapg.properties.checksum, dict, frozendict.frozendict, schemas.Unset] = schemas.unset,
        ...
        lastDownloaded: typing.Union[MetaOapg.properties.lastDownloaded, str, datetime, schemas.Unset] = schemas.unset,
        uploader: typing.Union[MetaOapg.properties.uploader, str, schemas.Unset] = schemas.unset,
        uploaderIp: typing.Union[MetaOapg.properties.uploaderIp, str, schemas.Unset] = schemas.unset,
