...
class AnonymousAccessSettingsXO(schemas.DictSchema):
    ...
    @typing.overload
    def __getitem__(
        self, name: typing_extensions.Literal["realmName"]
    ) -> MetaOapg.properties.realmName:
        ...
    ...
    def get_item_oapg(
        self, name: typing_extensions.Literal["realmName"]
    ) -> typing.Union[MetaOapg.properties.realmName, schemas.Unset]:
        ...
    ...
    def __new__(
        ...
        *_args: typing.Union[
        ...
        realmName: typing.Union[
            MetaOapg.properties.realmName, str, schemas.Unset
        ] = schemas.unset,
