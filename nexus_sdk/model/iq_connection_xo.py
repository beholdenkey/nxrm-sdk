...
class IqConnectionXo(schemas.DictSchema):
    ...
    class MetaOapg:
        ...
        class properties:
            class authenticationType(schemas.EnumBase, schemas.StrSchema):
                class MetaOapg:
                    enum_value_to_name = {
                        "USER": "USER",
                        "PKI": "PKI",
            ...
            class timeoutSeconds(schemas.Int32Schema):
                class MetaOapg:
                    format = "int32"
    ...
    @typing.overload
    def __getitem__(
        self, name: typing_extensions.Literal["authenticationType"]
    ) -> MetaOapg.properties.authenticationType:
        ...
    ...
    @typing.overload
    def __getitem__(
        self, name: typing_extensions.Literal["showLink"]
    ) -> MetaOapg.properties.showLink:
        ...
    ...
    @typing.overload
    def __getitem__(
        self, name: typing_extensions.Literal["timeoutSeconds"]
    ) -> MetaOapg.properties.timeoutSeconds:
        ...
    ...
    def get_item_oapg(
        self, name: typing_extensions.Literal["showLink"]
    ) -> typing.Union[MetaOapg.properties.showLink, schemas.Unset]:
        ...
    ...
    def get_item_oapg(
        self, name: typing_extensions.Literal["timeoutSeconds"]
    ) -> typing.Union[MetaOapg.properties.timeoutSeconds, schemas.Unset]:
        ...
    ...
    def __new__(
        ...
        *_args: typing.Union[
        ...
        authenticationType: typing.Union[
            MetaOapg.properties.authenticationType,
            str,
        ],
        ...
        showLink: typing.Union[
            MetaOapg.properties.showLink, bool, schemas.Unset
        ] = schemas.unset,
        ...
        timeoutSeconds: typing.Union[
            MetaOapg.properties.timeoutSeconds, decimal.Decimal, int, schemas.Unset
        ] = schemas.unset,
        properties: typing.Union[
            MetaOapg.properties.properties, str, schemas.Unset
        ] = schemas.unset,
