...
class BlobStoreQuotaResultXO(schemas.DictSchema):
    ...
    @typing.overload
    def __getitem__(
        self, name: typing_extensions.Literal["isViolation"]
    ) -> MetaOapg.properties.isViolation:
        ...
    ...
    def get_item_oapg(
        self, name: typing_extensions.Literal["isViolation"]
    ) -> typing.Union[MetaOapg.properties.isViolation, schemas.Unset]:
        ...
    ...
    def __new__(
        ...
        *_args: typing.Union[
        ...
        isViolation: typing.Union[
            MetaOapg.properties.isViolation, bool, schemas.Unset
        ] = schemas.unset,
