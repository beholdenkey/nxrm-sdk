...
class HttpClientConnectionAuthenticationAttributes(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["type", "username", "password", "ntlmHost", "ntlmDomain", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["type", "username", "password", "ntlmHost", "ntlmDomain", ], str]):
