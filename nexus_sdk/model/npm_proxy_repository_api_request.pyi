...
class NpmProxyRepositoryApiRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "online", "storage", "proxy", "negativeCache", "httpClient", "cleanup", "routingRule", "replication", "npm", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "online", "storage", "proxy", "negativeCache", "httpClient", "cleanup", "routingRule", "replication", "npm", ], str]):
