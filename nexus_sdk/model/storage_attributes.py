...
class StorageAttributes(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["strictContentTypeValidation", "blobStoreName", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["strictContentTypeValidation", "blobStoreName", ], str]):
