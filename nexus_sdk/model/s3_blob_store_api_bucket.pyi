...
class S3BlobStoreApiBucket(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["region", "name", "expiration", "prefix", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["region", "name", "expiration", "prefix", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        expiration: typing.Union[MetaOapg.properties.expiration, decimal.Decimal, int, ],
