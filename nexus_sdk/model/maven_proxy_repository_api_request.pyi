...
class MavenProxyRepositoryApiRequest(
    schemas.DictSchema
):
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["httpClient"]) -> 'HttpClientAttributesWithPreemptiveAuth': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "online", "storage", "proxy", "negativeCache", "httpClient", "maven", "cleanup", "routingRule", "replication", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["httpClient"]) -> 'HttpClientAttributesWithPreemptiveAuth': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "online", "storage", "proxy", "negativeCache", "httpClient", "maven", "cleanup", "routingRule", "replication", ], str]):
