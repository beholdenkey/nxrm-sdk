...
class S3BlobStoreApiModel(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def bucketConfiguration() -> typing.Type['S3BlobStoreApiBucketConfiguration']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["bucketConfiguration"]) -> 'S3BlobStoreApiBucketConfiguration': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "bucketConfiguration", "softQuota", "type", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["bucketConfiguration"]) -> 'S3BlobStoreApiBucketConfiguration': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "bucketConfiguration", "softQuota", "type", ], str]):
