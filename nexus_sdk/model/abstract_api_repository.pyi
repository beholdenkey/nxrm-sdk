...
class AbstractApiRepository(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["online", "name", "format", "type", "url", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["online", "name", "format", "type", "url", ], str]):
