...
class RawHostedRepositoryApiRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "online", "storage", "cleanup", "component", "raw", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "online", "storage", "cleanup", "component", "raw", ], str]):
