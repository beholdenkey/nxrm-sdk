...
class RoleXOResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "source", "name", "description", "readOnly", "privileges", "roles", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "source", "name", "description", "readOnly", "privileges", "roles", ], str]):
