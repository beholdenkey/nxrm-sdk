...
class YumHostedApiRepository(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["online", "storage", "yum", "name", "cleanup", "component", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["online", "storage", "yum", "name", "cleanup", "component", ], str]):
