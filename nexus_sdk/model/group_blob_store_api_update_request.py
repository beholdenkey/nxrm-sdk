...
class GroupBlobStoreApiUpdateRequest(schemas.DictSchema):
    ...
    class MetaOapg:
        class properties:
            ...
            class fillPolicy(schemas.EnumBase, schemas.StrSchema):
                class MetaOapg:
                    enum_value_to_name = {
                        "roundRobin": "ROUND_ROBIN",
                        "writeToFirst": "WRITE_TO_FIRST",
                    }
    ...
    @typing.overload
    def __getitem__(
        self, name: typing_extensions.Literal["fillPolicy"]
    ) -> MetaOapg.properties.fillPolicy:
        ...
    ...
    def get_item_oapg(
        self, name: typing_extensions.Literal["fillPolicy"]
    ) -> typing.Union[MetaOapg.properties.fillPolicy, schemas.Unset]:
        ...
    ...
    def __new__(
        ...
        *_args: typing.Union[
        ...
        fillPolicy: typing.Union[
            MetaOapg.properties.fillPolicy, str, schemas.Unset
        ] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[
