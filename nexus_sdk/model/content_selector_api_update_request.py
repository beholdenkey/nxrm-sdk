...
class ContentSelectorApiUpdateRequest(schemas.DictSchema):
    ...
    @typing.overload
    def __getitem__(
        self, name: typing_extensions.Literal["expression"]
    ) -> MetaOapg.properties.expression:
        ...
    ...
    def get_item_oapg(
        self, name: typing_extensions.Literal["expression"]
    ) -> typing.Union[MetaOapg.properties.expression, schemas.Unset]:
        ...
    ...
    def __new__(
        ...
        *_args: typing.Union[
        ...
        expression: typing.Union[
            MetaOapg.properties.expression, str, schemas.Unset
        ] = schemas.unset,
