...
class IqConnectionVerificationXo(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["success", "reason", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["success", "reason", ], str]):
