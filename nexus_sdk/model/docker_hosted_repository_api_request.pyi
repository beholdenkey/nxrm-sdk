...
class DockerHostedRepositoryApiRequest(
    schemas.DictSchema
):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def storage() -> typing.Type['DockerHostedStorageAttributes']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["storage"]) -> 'DockerHostedStorageAttributes': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "online", "storage", "docker", "cleanup", "component", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["storage"]) -> 'DockerHostedStorageAttributes': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "online", "storage", "docker", "cleanup", "component", ], str]):
