...
class AptProxyApiRepository(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def apt() -> typing.Type['AptProxyRepositoriesAttributes']:
                return AptProxyRepositoriesAttributes
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["apt"]) -> 'AptProxyRepositoriesAttributes': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["online", "storage", "proxy", "negativeCache", "httpClient", "apt", "name", "cleanup", "routingRuleName", "replication", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["apt"]) -> 'AptProxyRepositoriesAttributes': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["online", "storage", "proxy", "negativeCache", "httpClient", "apt", "name", "cleanup", "routingRuleName", "replication", ], str]):
