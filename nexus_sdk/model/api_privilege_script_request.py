...
class ApiPrivilegeScriptRequest(schemas.DictSchema):
    ...
    @typing.overload
    def __getitem__(
        self, name: typing_extensions.Literal["scriptName"]
    ) -> MetaOapg.properties.scriptName:
        ...
    ...
    def get_item_oapg(
        self, name: typing_extensions.Literal["scriptName"]
    ) -> typing.Union[MetaOapg.properties.scriptName, schemas.Unset]:
        ...
    ...
    def __new__(
        ...
        *_args: typing.Union[
        ...
        scriptName: typing.Union[
            MetaOapg.properties.scriptName, str, schemas.Unset
        ] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[
