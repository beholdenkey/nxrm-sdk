...
class DockerProxyRepositoryApiRequest(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "online", "storage", "proxy", "negativeCache", "httpClient", "docker", "dockerProxy", "cleanup", "routingRule", "replication", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "online", "storage", "proxy", "negativeCache", "httpClient", "docker", "dockerProxy", "cleanup", "routingRule", "replication", ], str]):
