...
class YumHostedRepositoryApiRequest(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def yum() -> typing.Type['YumAttributes']:
                return YumAttributes
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["yum"]) -> 'YumAttributes': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "online", "storage", "yum", "cleanup", "component", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["yum"]) -> 'YumAttributes': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "online", "storage", "yum", "cleanup", "component", ], str]):
